...
if (isset($_POST['dangnhap'])) {
  ...
  $sql = "SELECT * FROM users WHERE taiKhoan='" . $taikhoan . "' AND matKhau='" . $matkhau . "'  LIMIT 1";
...
<head>
  ...
  <style>
    ...
    .right {
      background: linear-gradient(212.38deg, rgba(242, 57, 127, 0.7) 0%, rgba(175, 70, 189, 0.71) 100%), url(https://cf.shopee.vn/file/6aba1d32171c02c7e0c3d59a5f75fbb8);
      ...
      <div class="left">
        ...
        <div class="contact">
          <form action="" method="POST">
            ...
            <a href="../signin/signin.php">Đăng ký ngay</a>
          </form>
        </div>
      </div>
      <div class="right">
